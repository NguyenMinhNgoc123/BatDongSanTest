...
class ProductDBSell {
    public static function getProducts($begin,$row_per_page){
        $db = Database::getDB();
        try {
            $query1 = "SELECT * FROM add_property WHERE update_note < NOW() and note = '1' and ptype_id='1' ORDER BY kind_id DESC , update_note DESC LIMIT {$begin},{$row_per_page}";
    ...
    public static function getProductsRowCount(){
        $db = Database::getDB();
        try {
            $query1 = "SELECT * FROM add_property WHERE update_note < NOW() and note = '1' and ptype_id='1' ORDER BY kind_id DESC , update_note DESC ";
            $statement1 = $db->prepare($query1);
            $statement1->execute();
    ...
    public static function getProductsCount(){
        $db = Database::getDB();
        try {
            $query1 = "SELECT * FROM add_property WHERE note = '1' and ptype_id='1' ";
            $statement1 = $db->prepare($query1);
            $statement1->execute();
            $result1 = $statement1->rowCount();
            $statement1->closeCursor();
    ...
    public static function getProductsVip(){
        $db = Database::getDB();
        try {
            $query1 = "SELECT * FROM add_property WHERE update_note < NOW() and note = '1' and ptype_id='1' and kind_id ='3'  ORDER BY update_note DESC";
            $statement1 = $db->prepare($query1);
            $statement1->execute();
            $statement1->rowCount();
            $result1 = $statement1->fetchAll();
    ...
    public static function getProductsEndow(){
        $db = Database::getDB();
        try {
            $query1 = "SELECT * FROM add_property WHERE update_note < NOW() and note = '1' and ptype_id='1' and kind_id ='2' ORDER BY update_note DESC";
            $statement1 = $db->prepare($query1);
            $statement1->execute();
            $statement1->rowCount();
            $result1 = $statement1->fetchAll();
    ...
    public static function getProductsOften(){
        $db = Database::getDB();
        try {
            $query1 = "SELECT * FROM add_property WHERE update_note < NOW() and note = '1' and ptype_id='1' and kind_id ='1' ORDER BY update_note DESC";
            $statement1 = $db->prepare($query1);
            $statement1->execute();
            $statement1->rowCount();
            $result1 = $statement1->fetchAll();
    ...
    public static function getProductsSearchAll($begin,$row_per_page,$caption,$city_id,$district_id,$ward_id,$price_begin,$price_end,$land_area_begin,$land_area_end){
        $db = Database::getDB();
        try {
            $query1 = "SELECT * FROM add_property where update_note < NOW() and note = '1' and ptype_id='1' and estimated_price BETWEEN '$price_begin' AND '$price_end' AND land_area BETWEEN '$land_area_begin' AND '$land_area_end' 
    ...
    public static function getProductsSearchAllChouse($chouse_id,$begin,$row_per_page,$caption,$city_id,$district_id,$ward_id,$price_begin,$price_end,$land_area_begin,$land_area_end){
        $db = Database::getDB();
        try {
            $query1 = "SELECT * FROM add_property where update_note < NOW() and chouse_id='$chouse_id' and note = '1' and ptype_id='1' and estimated_price BETWEEN '$price_begin' AND '$price_end' AND land_area BETWEEN '$land_area_begin' AND '$land_area_end' 
                              AND city_id ='$city_id'AND district_id ='$district_id' AND ward_id ='$ward_id' AND concat(caption) like '%$caption%' ORDER BY kind_id DESC , update_note DESC LIMIT {$begin},{$row_per_page}";
            $statement1 = $db->prepare($query1);
            $statement1->execute();
            $statement1->rowCount();
