...
if (isset($_GET['page']) && isset($_GET['row_per_page'])) {
    ...
    $begin = ($page * $row_per_page) - $row_per_page;
        ...
        if (isset($city_id) && isset($district_id) && isset($ward_id)) {
            if (isset($chouse_id)){
                $list_product = ProductDBSell::getProductsSearchAllChouse($chouse_id,$begin, $row_per_page, $caption, $city_id, $district_id, $ward_id, $price_begin, $price_end, $land_area_begin, $land_area_end);
            }else{
        ...
        if (isset($city_id) && isset($district_id) && (empty($ward_id) || $ward_id == null || $ward_id == ' ')) {
            if (isset($chouse_id)){
                $list_product = ProductDBSell::getProductsSearchCityDistrictChouse($chouse_id,$begin, $row_per_page, $caption, $city_id, $district_id, $price_begin, $price_end, $land_area_begin, $land_area_end);
            }else{
        ...
        if (isset($city_id) && (empty($district_id) || $district_id == null || $district_id == ' ') && (empty($ward_id) || $ward_id == null || $ward_id == ' ')) {
            if (isset($chouse_id)){
                $list_product = ProductDBSell::getProductsSearchCityChouse($chouse_id,$begin, $row_per_page, $caption, $city_id, $price_begin, $price_end, $land_area_begin, $land_area_end);
            }else{
        ...
        if (empty($city_id) && empty($district_id) && empty($ward_id)){
            if (isset($chouse_id)) {
                $list_product = ProductDBSell::getProductsSearchNotChouse($chouse_id,$begin, $row_per_page, $caption, $price_begin, $price_end, $land_area_begin, $land_area_end);
            }else{
